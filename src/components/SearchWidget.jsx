                ...
                <div className="modal-content relative z-2 max-w-2xl w-full pt-vw6 px-5 pb-5">
                    <div className="search-wrap bg-blank rounded-md shadow-sm">
                        ...
                        <form className="search-form flex w-full items-center text-base px-3">
                            <svg className="icon icon--search"><use xlinkHref="#icon-search"></use></svg>
                            <input id="search-field" className="w-full is-medium" type="text" placeholder="Search..." aria-label="Search box" ref={inputRef}/>
                        </form>
                        {/* {!-- show a message to the user if there is no post --} */}
                        <span className="js-search-message search-message text-sm p-2 text-gray-500 leading-none hidden">"No_results_found"</span>
                        {/* {!-- Search results --} */}
                    ...
                    <div className="justify-end text-xs leading-none text-white mt-2 hidden md:flex opacity-80">
                        <div className=""><span className="p-1 rounded bg-orange inline-block">↑</span> <span className="p-1 rounded bg-orange inline-block">↓</span>"Navigate_up_down"</div>
                        <div className="ml-3"><span className="p-1 rounded bg-orange inline-block">Enter</span> "Go_to_article"</div>
                        <div className="ml-3"><span className="p-1 rounded bg-orange inline-block">Esc</span> "Close_search"</div>
                    </div>
                </div>
            </div>
        </>
