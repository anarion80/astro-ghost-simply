export default {
  ...
  "Hey there!": "¡Hola!",
  "You don't have access to this post on <strong>{siteTitle}</strong> at the moment, but if you upgrade your account you'll be able to see the whole thing, as well as all the other posts in the archive! Subscribing only takes a few seconds and will give you immediate access.": "Por el momento no tienes acceso a esta publicación de <strong>{siteTitle}</strong>, pero si actualizas tu cuenta podrás verlo todo, ¡así como todas las demás publicaciones! La suscripción sólo lleva unos segundos y te dará acceso inmediato.",
  "Already have an account?": "¿Ya tienes una cuenta?",
  "You've successfully subscribed to": "Te has suscrito con éxito a",
  "Great! Next, complete checkout for full access to": "¡Excelente! A continuación, complete el pago para obtener acceso completo a",
  ...
  "Success! Your account is fully activated, you now have access to all content.": "¡Excelente! Su cuenta está completamente activada, ahora tiene acceso a todo el contenido.",
  ...
  "A collection of % posts": "Una colección de % artículos",
  "Get the best viral stories straight into your inbox!": "Obtenga las mejores historias virales directamente en su bandeja de entrada!",
